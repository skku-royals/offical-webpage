...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-zinc-200 bg-white px-3 py-5 text-sm shadow-sm ring-offset-white placeholder:text-zinc-500 focus:border-amber-400 focus:outline-none focus:ring-1 focus:ring-amber-400 disabled:cursor-not-allowed disabled:opacity-50 dark:border-zinc-400 dark:bg-transparent dark:ring-offset-zinc-950 dark:placeholder:text-zinc-400 dark:focus:border-amber-400 [&>span]:line-clamp-1',
      className
    )}
    {...props}
  >
